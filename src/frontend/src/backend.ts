...
import type { Order as _Order, OrderItem as _OrderItem, OrderStatus as _OrderStatus, Time as _Time, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
